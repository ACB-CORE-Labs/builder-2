...
def test_capability_promotion_doc_avoids_forbidden_identity_framing() -> None:
    ...
    assert "CORE Workbench is builder-II" not in content, "Forbidden global identity framing found regarding CORE Workbench"
...
def test_capability_promotion_doc_states_unpromoted_boundaries() -> None:
    ...
    assert "deepagents active delegation" in content or "Deepagents active delegation" in content, "Must mention deepagents active delegation"
