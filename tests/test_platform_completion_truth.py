...
def test_matrix_rendering_is_json_safe() -> None:
    ...
    assert decoded["summary"]["operationally_verified_count"] == 6  # B3 verifies target profiles, context packs, patch proposal, and governed read-only
