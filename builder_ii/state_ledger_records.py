...
def create_state_ledger_record(
    ...
    *,
    ...
    return {
        ...
        "governance": build_standard_governance("state_ledger_record"),
    }
...
def _validate_entry(entry: Any, index: int) -> list[str]:
    ...
    if not isinstance(entry.get("approved"), bool):
        ...
        errors.append(f"{prefix}.approved must be false or NOT_AUTHORIZED for blocked")
...
def validate_state_ledger_record(record: Any) -> list[str]:
    ...
    if not isinstance(governance, dict):
        ...
        errors.extend(validate_standard_governance(governance, "state_ledger_record"))
    return errors
