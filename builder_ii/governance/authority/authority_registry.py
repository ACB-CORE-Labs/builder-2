...
COMMAND_AUTHORITY_REGISTRY: tuple[CommandAuthorityRecord, ...] = (
    ...
    *READONLY_TUI_AUTHORITY_RECORDS,
    CommandAuthorityRecord(
        ...
        notes="STRATUM Mastery Resonance operator console. Gated behind --experimental (plan D5 / item 3.13). Tier evaluation is wired to this registry; the chain digest is shown as absent because none is reachable; prepare/subagent/HITL approve-reject are constitutive refusals; G may mint a passive read_only manifest only after ConfirmScreen, then launches builder-goose start-readonly; the HITL diff viewer is still a mockup.",
