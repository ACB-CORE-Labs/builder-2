...
COMMAND_AUTHORITY_REGISTRY: tuple[CommandAuthorityRecord, ...] = (
    ...
    *READONLY_TUI_AUTHORITY_RECORDS,
    ...
    CommandAuthorityRecord(
        ...
        tier=TIER_3,
        promotion_state=STATE_HITL_RUNTIME_CANDIDATE,
        runtime_boundary="Seals the frozen M1-v1 methodology and derives non-authoritative model runtime benchmark evidence from explicitly supplied raw samples; it does not install, pull, login, select providers, increase budgets, or promote capability.",
        write_boundary="Writes the benchmark manifest and report under the explicit --output directory only.",
        approval_mode=MODE_EXPLICIT_OPERATOR_INVOCATION,
        approval_boundary="Explicit operator invocation under the approved Plan Set 5 physical qualification envelope.",
        output_behavior="Writes digest-bound benchmark manifest/report JSON and exits non-zero unless every frozen hard threshold passes.",
