...
from builder_ii.governance.authority.governance_standard import build_standard_governance
...
from builder_ii.governance.hitl.hitl_patch_proposal import validate_hitl_patch_proposal_file
...
def apply_hitl_patch(
    ...
    bundle = {
        ...
        "governance": {
            ...
            # (builder_ii/governance/authority/assurance.py, platform_completion_audit.py:assurance_state_for_row) now
