...
from builder_ii.core.git_state import GIT_STATE_RECORD_KIND, validate_git_state_record
...
from builder_ii.governance.ledger.receipt_records import RECEIPT_RECORD_KIND, validate_receipt_record
from builder_ii.governance.ledger.receive_records import RECEIVE_RECORD_KIND, validate_receive_record
...
from builder_ii.lifecycle.setup.profile_pack import PROFILE_PACK_KIND, validate_profile_pack
...
def _validate_snapshot_record(record: Any) -> list[str]:
    from builder_ii.governance.ledger.snapshot_records import validate_snapshot_record
...
try:
    ...
    from builder_ii_code_vault.reconstruction import RECONSTRUCTION_KIND, validate_reconstruction
    from builder_ii_code_vault.relation_field import RELATION_FIELD_KIND, validate_relation_field
    from builder_ii_code_vault.reports.linter import LINTER_REPORT_KIND, validate_linter_report
    from builder_ii_code_vault.structural_field import STRUCTURAL_FIELD_KIND, validate_structural_field
    from builder_ii_code_vault.utility_eval_record import UTILITY_EVAL_RECORD_KIND, validate_utility_eval_record
