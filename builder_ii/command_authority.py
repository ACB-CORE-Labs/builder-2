...
_EXTRA_COMMAND_NAMES: tuple[str, ...] = (
    ...
    "builder-code-vault structural-field",
    ...
    "builder-code-vault utility-registry",
    "builder-code-vault validate-utility-registry",
    "builder-code-vault utility-baseline",
    "builder-code-vault validate-utility-eval",
    "builder-code-vault relation-field",
    "builder-code-vault change-field",
    "builder-code-vault evidence-relation",
    "builder-code-vault reconstruction",
