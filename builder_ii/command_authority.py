...
COMMAND_AUTHORITY_REGISTRY: tuple[CommandAuthorityRecord, ...] = (
    ...
    *READONLY_TUI_AUTHORITY_RECORDS,
    CommandAuthorityRecord(
        ...
        notes="STRATUM Mastery Resonance operator console. Gated behind --experimental (plan D5 / item 3.13). Tier evaluation is wired to this registry; the chain digest is shown as absent because none is reachable; writes, subagent dispatch, and HITL approve/reject are constitutive refusals, not pending features; the Goose keybinding is a launcher of builder-goose start-readonly, not a bypass around it; the HITL diff viewer is still a mockup.",
