...
COMMAND_AUTHORITY_REGISTRY: tuple[CommandAuthorityRecord, ...] = (
    ...
    CommandAuthorityRecord(
        ...
        notes="R1.2 passive setup planning only. Existing builder setup remains legacy/operator-managed until later R1 slices reconcile apply and rollback execution.",
    ),
    CommandAuthorityRecord(
