...
COMMAND_AUTHORITY_REGISTRY: tuple[CommandAuthorityRecord, ...] = (
    ...
    *READONLY_TUI_AUTHORITY_RECORDS,
    CommandAuthorityRecord(
        ...
        notes="STRATUM Command & Control TUI. Gated behind --experimental (plan D5 / item 3.13). Tier evaluation is wired to this registry; the chain digest is shown as absent because none is reachable; HITL approve/reject are constitutive refusals, not pending features; the HITL diff viewer is still a mockup.",
    ),
    CommandAuthorityRecord(
