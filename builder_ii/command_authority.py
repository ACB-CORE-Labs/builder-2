...
COMMAND_AUTHORITY_REGISTRY: tuple[CommandAuthorityRecord, ...] = (
    ...
    CommandAuthorityRecord(
        ...
        tier=TIER_1,
        promotion_state=STATE_ARTIFACT_ONLY,
        runtime_boundary="Delegates event-ledger list, replay, audit, export, and verification execution ledger query/validation subcommands without executing runtime work.",
