...
from builder_ii.adapters.goose.goose_inspection import validate_readonly_inspection_audit
from builder_ii.adapters.goose.goose_readonly import validate_readonly_runtime_audit
from builder_ii.adapters.goose.goose_session import validate_goose_session_manifest
...
from builder_ii.lifecycle.candidate.approval_records import validate_approval_record
...
def generate_mock_artifacts(kind: str, count: int) -> list[dict[str, Any]]:
    if kind == "builder_ii.goose_session_manifest":
        ...
        from builder_ii.governance.hitl.hitl_execution_records import create_hitl_execution_receipt
...
def benchmark_validator(kind: str, count: int, backend: str = "python") -> dict[str, Any]:
    from builder_ii.validation.rust_validator import validate_via_rust
