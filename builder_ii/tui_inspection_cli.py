...
def hitl_chain(chain_id: str | None = typer.Argument(None), verbose: bool = typer.Option(False, "--verbose", "-v")) -> None:
...
def hitl_approval(approval_id: str | None = typer.Argument(None), verbose: bool = typer.Option(False, "--verbose", "-v")) -> None:
    _dispatch("builder hitl approval", "builder_ii.hitl_tui", _args("approval", approval_id, verbose=verbose))


@hitl_app.command("evidence")
def hitl_evidence(evidence_id: str | None = typer.Argument(None), verbose: bool = typer.Option(False, "--verbose", "-v")) -> None:
...
def profile_lifecycle(pack_id: str | None = typer.Argument(None), verbose: bool = typer.Option(False, "--verbose", "-v")) -> None:
    _dispatch("builder profile lifecycle", "builder_ii.profile_tui", _args("lifecycle", pack_id, verbose=verbose))


@profile_app.command("validate")
def profile_validate(pack_id: str | None = typer.Argument(None), verbose: bool = typer.Option(False, "--verbose", "-v")) -> None:
...
def profile_render_plan(pack_id: str | None = typer.Argument(None), verbose: bool = typer.Option(False, "--verbose", "-v")) -> None:
...
def profile_dry_run(pack_id: str | None = typer.Argument(None), verbose: bool = typer.Option(False, "--verbose", "-v")) -> None:
...
def profile_resolve(profile: str | None = typer.Argument(None), verbose: bool = typer.Option(False, "--verbose", "-v")) -> None:
...
def model_routing_candidates(verbose: bool = typer.Option(False, "--verbose", "-v")) -> None:
    _dispatch("builder model routing candidates", "builder_ii.model_tui", _args("routing", "candidates", verbose=verbose))
...
def promote_artifact(artifact_id: str | None = typer.Argument(None), verbose: bool = typer.Option(False, "--verbose", "-v")) -> None:
...
def promote_decision(decision_id: str | None = typer.Argument(None), verbose: bool = typer.Option(False, "--verbose", "-v")) -> None:
...
def promote_compatibility(compatibility_id: str | None = typer.Argument(None), verbose: bool = typer.Option(False, "--verbose", "-v")) -> None:
    _dispatch("builder promote compatibility", "builder_ii.promote_tui", _args("compatibility", compatibility_id, verbose=verbose))
...
def postflight_record(record_id: str | None = typer.Argument(None), verbose: bool = typer.Option(False, "--verbose", "-v")) -> None:
...
def postflight_verify(record_id: str | None = typer.Argument(None), verbose: bool = typer.Option(False, "--verbose", "-v")) -> None:
...
def postflight_actions(record_id: str | None = typer.Argument(None), verbose: bool = typer.Option(False, "--verbose", "-v")) -> None:
...
def goose_manifest(manifest_id: str | None = typer.Argument(None), verbose: bool = typer.Option(False, "--verbose", "-v")) -> None:
...
def goose_actions(manifest_id: str | None = typer.Argument(None), verbose: bool = typer.Option(False, "--verbose", "-v")) -> None:
