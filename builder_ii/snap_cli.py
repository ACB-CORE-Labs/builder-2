...
def record(
    ...
    item, errors = create_snapshot_record_from_files(artifact_index_path, state_ledger_path, snapshot_name=snapshot_name, notes=notes)
    ...
    if output is not None:
        ...
        console.out(dumps_snapshot_record(item), end="")
