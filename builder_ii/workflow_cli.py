...
def promote(
    ...
    _run(lambda: promote_workflow(output_dir=_resolve_output_dir(session_id=session_id, output_dir=output_dir, workflows_dir=workflows_dir), requested_by=requested_by))
...
def candidate(
    ...
    _run(lambda: candidate_workflow(output_dir=_resolve_output_dir(session_id=session_id, output_dir=output_dir, workflows_dir=workflows_dir)))
...
def verify_chain(
    ...
    _run(lambda: verify_chain_workflow(output_dir=_resolve_output_dir(session_id=session_id, output_dir=output_dir, workflows_dir=workflows_dir)))
...
def handoff(
    ...
    _run(lambda: handoff_workflow(output_dir=_resolve_output_dir(session_id=session_id, output_dir=output_dir, workflows_dir=workflows_dir)))
...
def status(
    ...
    _run(lambda: workflow_status(output_dir=_resolve_output_dir(session_id=session_id, output_dir=output_dir, workflows_dir=workflows_dir)))
