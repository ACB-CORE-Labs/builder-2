...
def _orchestration_obligation_kinds() -> tuple[str, ...]:
    from builder_ii.core.orchestration_obligation import OBLIGATION_KINDS
...
def _enforce_obligation_mint(
    ...
    *,
    ...
    """
    from builder_ii.core.orchestration_lane_policy import LanePolicyViolation, require_lane_match
    from builder_ii.core.orchestration_obligation import fits_within
