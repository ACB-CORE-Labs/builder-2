...
from builder_ii.core.context_packs import create_architecture_aware_context_pack
...
from builder_ii.lifecycle.setup.profile_pack import create_profile_pack, write_profile_pack
from builder_ii.lifecycle.setup.profile_pack_dry_run import create_profile_pack_dry_run, write_profile_pack_dry_run
from builder_ii.lifecycle.setup.profile_pack_manifest import create_profile_pack_manifest, write_profile_pack_manifest
...
from builder_ii.lifecycle.setup.target_profiles import TargetName, target_profile, write_target_profile_artifact
...
def plan_workflow(
    *,
    ...
    transition = create_workflow_transition(
        ...
        subject_refs=base_subject_refs,
