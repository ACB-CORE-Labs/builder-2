...
#
# Read `builder_ii/governance/authority/assurance.py` for what each state means before adding a line here. The state
...
def assurance_state_for_row(row: CapabilityRow) -> AssuranceState:
    ...
    try:
        ...
        raise UnclassifiedCapabilityError(
            ...
            "There is no default: decide what the capability does (see builder_ii/governance/authority/assurance.py) "
...
REQUIRED_CAPABILITY_ROWS: tuple[CapabilityRow, ...] = (
    ...
    _row(
        "target profiles",
        OPERATIONALLY_VERIFIED,
        ("builder_ii/lifecycle/setup/target_profiles.py", "builder_ii/cli/targets_cli.py", "builder_ii/governance/authority/readonly_authority.py"),
    ...
    _row(
        "agent profiles",
        PASSIVE_FOUNDATION,
        ("builder_ii/routing/agent_profiles.py", "builder_ii/cli/agent_cli.py"),
        ("builder-agent",),
    ...
    _row(
        ...
        PASSIVE_FOUNDATION,
        (
            "builder_ii/lifecycle/candidate/verification_profiles.py",
    ...
    _row(
        ...
        (
            ...
            "builder_ii/core/context_packs.py",
    ...
    _row(
        ...
        PASSIVE_FOUNDATION,
        (
            "builder_ii/lifecycle/setup/profile_pack_manifest.py",
            "builder_ii/lifecycle/setup/profile_pack_render_plan.py",
            "builder_ii/lifecycle/setup/profile_pack_dry_run.py",
            "builder_ii/lifecycle/setup/profile_pack.py",
        ),
    ...
    _row(
        "config schema",
        PASSIVE_FOUNDATION,
        ("builder_ii/core/config_schema.py", "builder_ii/core/config.py", "docs/CONFIG_ONBOARDING.md"),
        ("builder-config",),
    ...
    _row(
        "config source precedence",
        PASSIVE_FOUNDATION,
        ("builder_ii/core/config_sources.py", "builder_ii/cli/config_cli.py", "docs/CONFIG_ONBOARDING.md"),
        ("builder-config",),
    ...
    _row(
        ...
        (
            ...
            "builder_ii/lifecycle/setup/init_decisions.py",
    ...
    _row(
        ...
        (
            ...
            "builder_ii/lifecycle/setup/setup_plan.py",
            "builder_ii/lifecycle/setup/setup_overlay.py",
            "builder_ii/lifecycle/setup/setup_rollback.py",
            "builder_ii/lifecycle/setup/setup_apply.py",
            "builder_ii/lifecycle/setup/setup_receipt.py",
            "builder_ii/cli/setup_cli.py",
        ),
    ...
    _row(
        "Goose config overlay/rollback",
        PASSIVE_FOUNDATION,
        ("builder_ii/lifecycle/setup/setup_overlay.py", "builder_ii/lifecycle/setup/setup_rollback.py", "builder_ii/adapters/goose/goose_setup.py"),
    ...
    _row(
        "HITL decision envelope",
        ARTIFACT_ONLY,
        ("builder_ii/governance/hitl/hitl_decision_envelope.py", "docs/ARTIFACT_INDEX.md"),
    ...
    _row(
        "recipe generator/wizard",
        ARTIFACT_ONLY,
        ("recipes/core-platform.yaml", "builder_ii/adapters/goose/goose_recipe_context_projection.py"),
    ...
    _row(
        "skill generator/installer/validator",
        MERGED_BUT_NOT_OPERATIONAL,
        (".agents/skills/core-governed-coding/SKILL.md", "builder_ii/lifecycle/setup/setup_overlay.py", "builder_ii/adapters/goose/goose_setup.py"),
    ...
    _row(
        "target profile wizard",
        NOT_STARTED,
        ("builder_ii/lifecycle/setup/target_profiles.py", "builder_ii/cli/targets_cli.py"),
        ("builder-targets",),
    ...
    _row(
        "verification profile wizard",
        NOT_STARTED,
        ("builder_ii/lifecycle/candidate/verification_profiles.py", "builder_ii/cli/verification_cli.py"),
        ("builder-verification",),
    ...
    _row(
        ...
        NOT_STARTED,
        (
            "builder_ii/adapters/deepagents/deepagents_policy.py",
            "builder_ii/adapters/deepagents/deepagents_readiness.py",
    ...
    _row(
        ...
        (
            ...
            "builder_ii/lifecycle/setup/setup_apply.py",
            "builder_ii/lifecycle/setup/setup_receipt.py",
            "builder_ii/lifecycle/setup/setup_rollback_execute.py",
            "builder_ii/lifecycle/setup/setup_rollback_receipt.py",
            "builder_ii/governance/ledger/receipt_records.py",
    ...
    _row(
        "model registry",
        OPERATIONALLY_VERIFIED,
        ("builder_ii/routing/model_client_registry.py", "builder_ii/routing/model_execution_gateway.py"),
    ...
    _row(
        ...
        (
            ...
            "builder_ii/routing/direct_chat.py",
            "builder_ii/routing/backends.py",
        ),
    ...
    _row(
        "tool registry",
        PASSIVE_FOUNDATION,
        ("builder_ii/core/tool_registry.py", "builder_ii/cli/tools_cli.py"),
        ("builder-tools",),
    ...
    _row(
        "passive orchestration assignment",
        PASSIVE_FOUNDATION,
        ("builder_ii/core/orchestration_assignment.py", "builder_ii/cli/orchestration_cli.py"),
    ...
    _row(
        "workflow/event ledger",
        PASSIVE_FOUNDATION,
        ("builder_ii/core/workflow_orchestrator.py", "builder_ii/governance/ledger/workflow_records.py", "builder_ii/governance/ledger/event_ledger.py"),
    ...
    _row(
        "replay/audit",
        PASSIVE_FOUNDATION,
        ("builder_ii/governance/ledger/event_ledger.py", "builder_ii/core/artifact_chain_verification.py"),
    ...
    _row(
        "readonly founder demo",
        PASSIVE_FOUNDATION,
        ("builder_ii/core/readonly_founder_demo.py", "builder_ii/cli/targets_cli.py"),
        ("builder-targets",),
    ...
    _row(
        "orchestration founder demo wrapper",
        PASSIVE_FOUNDATION,
        ("builder_ii/core/readonly_founder_demo.py", "docs/demos/CORE_READONLY_FOUNDER_DEMO.md"),
        ("builder-targets",),
    ...
    _row(
        "HITL promotion bridge",
        PASSIVE_FOUNDATION,
        ("builder_ii/governance/hitl/hitl_promotion_artifacts.py", "builder_ii/cli/hitl_promotion_cli.py"),
        ("builder-hitl",),
    ...
    _row(
        "execution candidate manifests",
        PASSIVE_FOUNDATION,
        ("builder_ii/lifecycle/candidate/execution_candidate_manifest.py", "builder_ii/cli/execution_candidate_manifest_cli.py"),
        ("builder-hitl",),
    ...
    _row(
        ...
        (
            ...
            "builder_ii/lifecycle/candidate/verification_execution_receipt.py",
            "builder_ii/lifecycle/candidate/verification_execution_runner.py",
            "builder_ii/governance/ledger/verification_execution_ledger.py",
            "builder_ii/lifecycle/candidate/verification_runner_entrypoints.py",
            ...
            "builder_ii/governance/hitl/hitl_verification_candidate.py",
    ...
    _row(
        ...
        (
            ...
            "builder_ii/governance/hitl/hitl_patch_approval.py",
            "builder_ii/governance/hitl/hitl_patch_ledger.py",
            "builder_ii/cli/hitl_patch_cli.py",
            "builder_ii/governance/hitl/hitl_patch_proposal.py",
    ...
    _row(
        ...
        (
            "builder_ii/lifecycle/candidate/rollback_artifacts.py",
            "builder_ii/governance/hitl/hitl_rollback_approval.py",
            "builder_ii/governance/hitl/hitl_patch_ledger.py",
            "builder_ii/cli/hitl_patch_cli.py",
            "builder_ii/governance/hitl/hitl_patch_apply.py",
            "docs/audits/B4_CLOSURE_AUDIT.md",
    ...
    _row(
        "postflight verification",
        OPERATIONALLY_VERIFIED,
        ("builder_ii/lifecycle/candidate/execution_postflight_records.py", "builder_ii/lifecycle/candidate/verification_execution_runner.py"),
        ("builder-verify run-approved",),
    ...
    _row(
        "Goose setup",
        MERGED_BUT_NOT_OPERATIONAL,
        ("builder_ii/adapters/goose/goose_setup.py", "builder_ii/cli/main.py"),
        ("builder",),
        ("tests/test_goose_setup.py",),
        (
    ...
    _row(
        "governed read-only runtime",
        OPERATIONALLY_VERIFIED,
        ("builder_ii/governance/authority/readonly_authority.py", "builder_ii/cli/readonly_inspection_cli.py"),
    ...
    _row(
        ...
        OPERATIONALLY_VERIFIED,
        (
            "builder_ii/adapters/goose/goose_session.py",
    ...
    _row(
        "deepagents policy/readiness",
        PASSIVE_FOUNDATION,
        ("builder_ii/adapters/deepagents/deepagents_policy.py", "builder_ii/adapters/deepagents/deepagents_readiness.py", "builder_ii/adapters/deepagents/deepagents_bridge.py"),
        ("builder-deepagents",),
    ...
    _row(
        "deepagents passive work artifacts",
        PASSIVE_FOUNDATION,
        ("builder_ii/adapters/deepagents/deepagents_work_artifacts.py", "builder_ii/cli/deepagents_cli.py"),
        ("builder-deepagents",),
    ...
    _row(
        ...
        OPERATIONALLY_VERIFIED,
        (
            "builder_ii/core/orchestration_obligation.py",
            "builder_ii/core/orchestration_lane_policy.py",
            "builder_ii/adapters/deepagents/deepagents_execution.py",
            "builder_ii/lifecycle/candidate/verification_promotion_gate.py",
    ...
    _row(
        "operator quickstart/golden path",
        OPERATIONALLY_VERIFIED,
        ("docs/OPERATOR_QUICKSTART.md", "builder_ii/lifecycle/setup/operator_golden_path.py", "builder_ii/lifecycle/setup/operator_lane.py"),
        (
    ...
    _row(
        ...
        (
            ...
            "builder_ii/cli/platform_status_cli.py",
            "builder_ii/core/r1_closure_report.py",
            "docs/PLATFORM_COMPLETION_AUDIT.md",
        ),
        ("builder-platform",),
        (
    ...
    _row(
        ...
        ("tests/test_release_manifest.py", "tests/test_v0_release_proof_harness.py", "tests/test_quality_gates.py"),
        (
    ...
    _row(
        "command authority as runtime gate",
        OPERATIONALLY_VERIFIED,
        ("builder_ii/governance/authority/", "docs/COMMAND_AUTHORITY.md"),
        ("builder-verify run-approved",),
        (
