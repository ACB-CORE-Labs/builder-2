...
from builder_ii.core.codevault_upsell import format_context_scale_upsell
...
def create_repo_map(
    ...
    *,
    ...
    data = {
        ...
        "truncated": truncated,
        # Only on genuine size/count truncation — never every scan.
        "upgrade_hint": format_context_scale_upsell() if truncated else None,
