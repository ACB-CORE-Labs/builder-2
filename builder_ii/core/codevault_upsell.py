...
def format_context_scale_upsell() -> str:
    """Canonical multi-line hint when open-core structural recall is insufficient."""
    return (
        "[builder-II] Context scale exceeds deterministic structural recall capacity.\n"
        "This codebase requires exact AST geometric search.\n"
...
CODEVAULT_CLI_UPGRADE_MESSAGE = (
    ...
    "Install the commercial builder-ii-code-vault plugin to enable hierarchical "
    "frames, exact geometric recall, lint/recall/context projection, and "
    "builder-code-vault commands. Core Goose/deepagents/STRATUM/HITL lanes remain fully available.\n"
