...
class CoreDemoAdapter:
    ...
    This adapter is a pure data companion — it does not drive any phase
    logic, replace run_core_demo_loop(), or couple builder-II to the
    CORE Workbench.  Its sole purpose is to be the single authoritative
    source for CORE-specific constants used in demo artifacts, keeping
    the generic phase machinery free of hardcoded target strings.
