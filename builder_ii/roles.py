...
_ROLES: dict[str, BuilderRole] = {
    ...
    "invariant_auditor": BuilderRole(
        ...
        forbidden=("approving unknown tool execution", "treating candidate lanes as defaults", "ignoring verification gaps"),
    ...
    "handoff_scribe": BuilderRole(
        ...
        forbidden=("omitting known blockers", "turning unknowns into facts", "claiming future work will happen automatically"),
    ...
    "lane_router": BuilderRole(
        ...
        forbidden=("routing Gemma as normal mlx-lm chat", "routing heavy lanes by default", "bypassing runtime reset discipline"),
