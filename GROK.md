...
- **CodeVault (Commercial Upgrade)**: CodeVault is a separate, privately licensed plugin. The open-core `builder-code-vault` seam refuses with status `1` when that package is unavailable.
