...
## **1\. Traceability vs. The Digest Invariant**
...
* **Behavior:** Up/down movement triggers a detailed side-pane expansion in the Center Panel showing governance metadata (digests, receipt paths, and reconstruction evidence) from the open-core ledger without fabricating missing data.
