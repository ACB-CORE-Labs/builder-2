...
7. Full Linux CI parity; container isolation for the verification lane
...
The retained non-proprietary audit inputs are under `planning/evidence/`. Commercial-plugin
analysis and review material is maintained outside this repository.
