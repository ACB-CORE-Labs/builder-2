...
| [`ADR-0007`](ADR-0007-orchestration-router-control-plane.md) | Proposed | Geometry-first WRP orchestration & routing control plane as digest-bound recommendation/plan/validation artifacts; no live multi-agent execution authority. |
