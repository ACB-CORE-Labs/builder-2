...
boundary: `builder-code-vault` delegates to an installed package and otherwise fails closed with an
upgrade notice. The plugin's implementation, command inventory, design records, and development
