...
| S4 | Backend promotions (embed / OPA / LangGraph / vLLM research) | Open — W.6 drafts + HUMAN handoff (`planning/evidence/s4_review_summary.md`, exchange `mastery/S4-readiness/`); HUMAN decides each; `s4_promoted=false` |
