...
| S2 | HITL live lane (`builder-wrp run-approved`) | **Code on main (v1)**; readiness ready; **promotion decision still blocked** until G-LEAD PASS + HUMAN (`wrp_s2_decision.json`) |
