...
| Absolute mastery | **In progress** — P0–P5 + S1/S2 decided; S3 readiness draft + **blocked** decision; **P6 / P7 open** (see [`WRP_MASTERY_PROGRESS.md`](WRP_MASTERY_PROGRESS.md)) |
...
| S3 | Scoped `enabled` for declared profiles | **Readiness drafted; decision blocked** (`planning/evidence/wrp_s3_{readiness,decision}.json`) — Class U does not promote; no enablement runtime |
