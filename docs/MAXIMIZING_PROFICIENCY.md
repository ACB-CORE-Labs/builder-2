...
A **deepagent** is a specialized subagent profile built to run designated task workloads (such as code research, database debugging, or security audits) under explicit capability gates and governed execution envelopes.
