...
| Live lane `run-approved` | `PARTIAL` | P3 / S2 | **Code on main (v1)** plan/approve/run-approved + tests; **decision still blocked** until G-LEAD PASS + HUMAN; no gateway nodes yet |
