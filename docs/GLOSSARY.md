...
### Digest-Bound
Any process, structure, or reference anchored to a cryptographic content hash of its input files or artifacts. This binds byte identity relative to the recorded digest; it does not prove that a human reviewed the bytes.
