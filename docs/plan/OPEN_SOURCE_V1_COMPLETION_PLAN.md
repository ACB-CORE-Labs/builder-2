...
- `docs/plan/CODE_VAULT_TIER1_ENCODER_RFC.md` ->
  `docs/architecture/CODE_VAULT_TIER1_ENCODER.md`
...
- `docs/plan/CODE_VAULT_EXECUTION_MAP.md`
- `docs/plan/CODE_VAULT_G1B_WAVE_BRIEFS.md`
- `docs/plan/CODE_VAULT_G1_WAVE_BRIEFS.md`
- `docs/plan/CODE_VAULT_G2_WAVE_BRIEFS.md`
- `docs/plan/CODE_VAULT_MASTER_PLAN.md`
- `docs/plan/CODE_VAULT_SEPARATION_PLAN.md`
