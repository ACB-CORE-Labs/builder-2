...
| UOW-106 | 1 | `IN_PROGRESS` | canonical governed Goose start/close evidence and events | two independent audits rejected earlier exact tips; second-round WAL-authority, transcript-fd-custody, and typed approved-evidence repairs are implemented locally but still require the full focused battery, a new committed-tip audit, and full local CI |
